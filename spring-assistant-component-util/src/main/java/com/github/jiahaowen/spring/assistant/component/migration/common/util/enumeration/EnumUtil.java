...
import com.github.jiahaowen.spring.assistant.component.migration.common.util.enumeration.Enum.EnumType;
        ...
        synchronized (enumClass) {
            ...
            if (enumType == null) {
                Method createEnumTypeMethod =
                        findStaticMethod(
                                enumClass, EnumConstant.CREATE_ENUM_TYPE_METHOD_NAME, new Class[0]);
