...
import com.github.jiahaowen.spring.assistant.component.migration.common.util.ClassLoaderUtil;
import com.github.jiahaowen.spring.assistant.component.migration.common.util.StringUtil;
import com.github.jiahaowen.spring.assistant.component.migration.common.util.enumeration.internal.EnumConstant;
import com.github.jiahaowen.spring.assistant.component.migration.common.util.enumeration.internal.NumberType;
...
public abstract class Enum extends Number implements NumberType, Comparable, Serializable {
    ...
    private static Enum createEnum(String name, Number value, boolean withValue) {
        ...
        try {
            ...
            throw ServiceException.buildInternalEx("Could not find enum class " + enumClassName, e);
        }
    ...
    private static String getCallerClassName() {
        ...
        throw ServiceException.buildInternalEx("Cannot get Enum-class name");
    }
     ...
     * @return 如果等于<code>0</code>, 表示值相等, 大于<code>0</code>表示当前的枚举量的值比<code>otherEnum</code>大, 小于
     *     <code>0</code>表示当前的枚举量的值比<code>otherEnum</code>小
     */
    @Override
        ...
        if (!getClass().equals(otherEnum.getClass())) {
            throw ServiceException.buildInternalEx(
                    MessageFormat.format(
                            EnumConstant.COMPARE_TYPE_MISMATCH,
    ...
    protected Object readResolve() throws ObjectStreamException {
        ...
        if (enumObject == null) {
            throw new InvalidClassException(
                    "Enum name \"" + getName() + "\" not found in class " + enumClass.getName());
        }

        if (!enumObject.value.equals(value)) {
            throw new InvalidClassException(
                    "Enum value \"" + value + "\" does not match in class " + enumClass.getName());
        }
                ...
                for (int i = 0; i < fields.length; i++) {
                    ...
                    if (Modifier.isPublic(modifier)
                        ...
                        try {
                            ...
                            Throwables.throwIfUnchecked(e);
                            throw ServiceException.buildInternalEx(e);
                        }
                    }
                }
            }
