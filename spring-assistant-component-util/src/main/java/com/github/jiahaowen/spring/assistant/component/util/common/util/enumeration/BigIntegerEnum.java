...
public abstract class BigIntegerEnum extends Enum {
    ...
    public String toHexString() {
        return ((BigInteger) getValue()).toString(NumberType.RADIX_HEX);
    }
    ...
    public String toOctalString() {
        return ((BigInteger) getValue()).toString(NumberType.RADIX_OCT);
    }
    ...
    public String toBinaryString() {
        return ((BigInteger) getValue()).toString(NumberType.RADIX_BIN);
    }
}
