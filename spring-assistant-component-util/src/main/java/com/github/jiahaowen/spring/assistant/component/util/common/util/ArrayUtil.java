...
public class ArrayUtil {
    ...
    public static Object[] defaultIfNull(Object[] array, Class defaultComponentType) {
        return (array == null)
                ? (Object[])
                        Array.newInstance(ClassUtil.getNonPrimitiveType(defaultComponentType), 0)
                : array;
    }
     ...
     *
     * <p>此方法实际上和<code>defaultIfNull(Object[])</code>等效。
     *
     * <pre>
     ...
     *
     * <p>如果比较的对象不是数组，则此方法的结果同<code>ObjectUtil.equals</code>。
     *
     * @param array1 数组1
     * @param array2 数组2
    ...
    public static boolean equals(Object array1, Object array2) {
        ...
        if (array1 instanceof long[]) {
            ...
            for (int i = 0; i < doubleArray1.length; i++) {
                if (Double.doubleToLongBits(doubleArray1[i])
                        != Double.doubleToLongBits(doubleArray2[i])) {
                    return false;
                }
            }
     ...
     *
     * <p>如果对象不是数组，则此方法的结果同<code>ObjectUtil.hashCode</code>。
     *
     * @param array 数组
     * @return hash值
     */
     ...
     *
     * <p>如果输入数组为<code>null</code>，则返回<code>null</code>。
     *
     * <p>该方法内部调用<code>java.util.Arrays.asList</code>方法所返回的列表为指定数组的映像（固定长度），因此性能和内存占用上比<code>toList
     * </code>方法更优。
     *
     * <p>这个方法常被用于初始化，例如：
     *
     ...
     * <p>如果输入数组为<code>null</code>，则返回<code>null</code>。
     *
     * <p>该方法返回的列表为指定数组的复本，而<code>java.util.Arrays.asList</code>方法所返回的列表为指定数组的映像（固定长度）。
     *
     * <p>这个方法常被用于初始化，例如：
     *
     * <pre>
     ...
     *
     * <p>此方法只进行“浅复制”，也就是说，数组中的对象本身不会被复制。 另外，此方法也不处理多维数组。
     *
     * @param array 要复制的数组
     ...
     * 在数组中查找一个元素。
     *
     * <p>如果未找到或数组为<code>null</code>则返回<code>-1</code>。
     *
     * @param array 要扫描的数组
     ...
     * <p>如果未找到或数组为<code>null</code>则返回<code>-1</code>。
     *
     * <p>起始索引小于<code>0</code>则看作<code>0</code>，超出数组长度的起始索引则返回<code>-1</code>。
     *
     * @param array 要扫描的数组
     * @param objectToFind 要查找的元素
     ...
     * <p>如果未找到或数组为<code>null</code>则返回<code>-1</code>。
     *
     * <p>起始索引小于<code>0</code>则返回<code>-1</code>，超出数组长度的起始索引则从数组末尾开始找。
     *
     * @param array 要扫描的数组
     * @param objectToFind 要查找的元素
     * @param startIndex 起始索引
     ...
     * 判断指定对象是否存在于指定数组中。
     *
     * <p>如果数组为<code>null</code>则返回<code>false</code>。
     *
     * @param array 要扫描的数组
     * @param objectToFind 要查找的元素
    ...
    public static int indexOf(
            double[] array, double doubleToFind, int startIndex, double tolerance) {
        if (array == null) {
            return -1;
        }
     ...
     */
    public static int indexOf(
            double[] array, double[] arrayToFind, int startIndex, double tolerance) {
        if ((array == null) || (arrayToFind == null)) {
            return -1;
        }
     ...
     */
    public static int lastIndexOf(
            float[] array, float floatToFind, int startIndex, float tolerance) {
        if (array == null) {
            return -1;
        }
     ...
     */
    public static int lastIndexOf(
            float[] array, float[] arrayToFind, int startIndex, float tolerance) {
        if ((array == null) || (arrayToFind == null)) {
            return -1;
        }
     ...
     * 将数组转换成易于阅读的字符串表示。
     *
     * <p>如果数组是<code>null</code>则返回<code>[]</code>，支持多维数组。 如果数组元素为<code>null</code>，则显示<code>
     * &lt;null&gt;</code>。
     *
     * <pre>
     ...
     * 将数组转换成易于阅读的字符串表示。
     *
     * <p>如果数组是<code>null</code>则返回指定字符串，支持多维数组。 如果数组元素为<code>null</code>，则显示<code>&lt;null&gt;
     * </code>。
     *
     * <pre>
    ...
    private static void toString(
            StringBuffer buffer, Object array, String nullArrayStr, String nullElementStr) {
        if (array == null) {
