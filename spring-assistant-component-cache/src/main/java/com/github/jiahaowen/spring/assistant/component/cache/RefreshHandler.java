...
public class RefreshHandler {
    ...
    /** 正在刷新缓存队列 */
    private final ConcurrentHashMap<CacheKeyDTO, Byte> refreshing;
    ...
    public RefreshHandler(CacheHandler cacheHandler, AutoLoadConfig config) {
        ...
        refreshing = new ConcurrentHashMap<CacheKeyDTO, Byte>(queueCapacity);
    ...
    public void removeTask(CacheKeyDTO cacheKey) {
