...
public class AutoLoadDTO implements Serializable {
    ...
    public AutoLoadDTO(CacheKeyDTO cacheKey, CacheAopProxyChain joinPoint, Object args[], Cache cache, int expire) {
    ...
    public AutoLoadDTO setLastRequestTime(long lastRequestTime) {
        synchronized(this) {
     ...
     * @return this
     */
    public AutoLoadDTO setLastLoadTime(long lastLoadTime) {
     ...
     * @return this
     */
    public AutoLoadDTO setLoading(boolean loading) {
     ...
     * @return this
     */
    public AutoLoadDTO addUseTotalTime(long useTime) {
        synchronized(this) {
            this.loadCnt++;
     ...
     * @return this
     */
    public AutoLoadDTO setExpire(int expire) {
        this.expire=expire;
        return this;
    }
