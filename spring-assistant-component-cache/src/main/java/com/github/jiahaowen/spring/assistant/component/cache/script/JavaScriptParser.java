package com.github.jiahaowen.spring.assistant.component.cache.script;

import com.github.jiahaowen.spring.assistant.component.cache.CacheUtil;
...
public class JavaScriptParser extends AbstractScriptParser {
    ...
    private final ConcurrentHashMap<String, CompiledScript> expCache =
    ...
    public JavaScriptParser() {
        ...
        try {
            ...
            addFunction(
                    EMPTY,
                    CacheUtil.class.getDeclaredMethod("isEmpty", new Class[] {Object.class}));
        } catch (Exception e) {
    ...
    public void addFunction(String name, Method method) {
        try {
            ...
            funcs.append(
                    "function " + name + "(obj){return " + clsName + "." + methodName + "(obj);}");
        } catch (Exception e) {
            logger.error(e.getMessage(), e);
        }
    }
