## [AutoLoadConfig](../AutoLoadConfig.java "AutoLoadConfig") 配置

    <bean id="autoLoadConfig" class="com.github.jiahaowen.spring.assistant.component.cache.spring.config.AutoLoadConfig">
